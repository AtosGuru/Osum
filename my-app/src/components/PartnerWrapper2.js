...
export default class PartnerWrapper2 extends Component {
	render() {
		return (
			<div>
						...
						<div className="row">
							<div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
								...
								<div className="digital-heading aos-init aos-animate" dataaos="fade-up">
									...
									<h2 className="heading">Mobile app design specialized agency</h2>
									<label className="sub-heading">
										Born desire to make beautiful and functional mobile apps for EVERYONE.
									</label>
									<label className="sub-heading pad120">
										We love our jobs, we love our customers, and we love providing absolutely
								...
								<div className="trusted-brands">
									...
									<div className="project-sec">
										...
										<h2 className="heading aos-init" dataaos="fade-up">
											Do you have <span>app project in mind?</span>
										</h2>
										</Fade>
										<Fade bottom>
										<button
